...
| [Klipper UART connection guide](./Klipper/mods/uart_connection.md)    | Connect your Pi to your Mini E3 Inside the tub, keep it pretty.
...
## Operation Docs 
[Calculate Max Build_Height](./Calculate_max_build_height.md) - Updating Y-axis max_position and using it to calculate max_height.


## Mods (ish)
- [Mods Folder](./Klipper/mods/)
