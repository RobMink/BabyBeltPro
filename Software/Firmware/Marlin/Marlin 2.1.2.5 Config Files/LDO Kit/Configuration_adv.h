 ...
 */
//#define CONFIG_EXPORT 2 // :[1:'JSON', 2:'config.ini', 3:'schema.json', 4:'schezma.yml']
 ...
 */
#define E0_AUTO_FAN_PIN PC7 //LDO
...
//#define XY_COUNTERPART_BACKOFF_MM 50         // (mm) Backoff X after homing Y, and vice-versa
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SDCARD_AUTOMOUNT
  #define SDCARD_AUTOMOUNT_WITH_CD
